...
faceDetectionProto = os.path.join(path, 'models/models/deploy.prototxt.txt')
...
def pipeline_model(frame):
    ...
    for i, confidence in enumerate(detections[0, 0, :, 2]):
        if confidence > 0.5:
            ...
            cv2.putText(image, text_face, (startx, starty - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 2)
